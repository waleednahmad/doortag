                ...
                <div @click="rateBreakdownOpen = !rateBreakdownOpen"
                    ...
                    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-start space-y-3 sm:space-y-0">
                        <div class="flex items-center space-x-3 flex-1">
                            <!-- Carrier Logo -->
                            <div
                                class="w-12 h-12 bg-gradient-to-br from-blue-100 to-blue-50 dark:from-blue-900/30 dark:to-blue-900/10 rounded-lg flex items-center justify-center flex-shrink-0">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-sm text-gray-600 dark:text-gray-400">
                                    ...
                                    @if ($rate['estimated_delivery_date'])
                                        Arrives by
                                        {{ \Carbon\Carbon::parse($rate['estimated_delivery_date'])->format('M d, Y') }}
                                    @else
                        ...
                        <div class="text-center sm:text-right space-y-2">
                            <div class="flex items-center justify-end space-x-2 flex-wrap">
                                ...
                                @if ($selectedRate && $selectedRate['rate_id'] === $rate['rate_id'])
                                    <span
                                        class="inline-block px-2 py-1 bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400 text-xs font-semibold rounded">
                                        Selected
                                    </span>
                                @endif
                            </div>
                            ...
                            @if (isset($rate['price_comparison']) && $rate['price_comparison']['is_cheaper'] !== null)
                                ...
                                @if ($comparison['is_cheaper'] === 'carrier_1')
                                    <div
                                        class="inline-flex items-center space-x-1 px-3 py-1 bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 rounded-lg text-xs font-medium">
                                ...
                                @elseif ($comparison['is_cheaper'] === 'carrier_2')
                                    <div
                                        class="inline-flex items-center space-x-1 px-3 py-1 bg-orange-100 dark:bg-orange-900/30 text-orange-700 dark:text-orange-300 rounded-lg text-xs font-medium">
                                ...
                                @else
                                    <div
                                        class="inline-flex items-center space-x-1 px-3 py-1 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-lg text-xs font-medium">
                    ...
                    @if (isset($rate['error_messages']) && count($rate['error_messages']) > 0)
                        <div
                            class="mt-3 p-3 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-700 rounded">
