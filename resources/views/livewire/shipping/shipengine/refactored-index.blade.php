                ...
                <x-card class="mt-4 sm:mt-6">
                    ...
                    @if (!empty($rates))
                        ...
                        <div class="mt-6 pt-4 border-t border-gray-200 dark:border-gray-600 flex justify-between">
                            ...
                            {{-- Review Modal --}}
                            <x-shipping.review-modal :shipToAddress="$shipToAddress" :shipFromAddress="$shipFromAddress" :selectedRate="$selectedRate"
                                :selectedPackage="$selectedPackage" :package="$package" :customs="$customs" :certifyHazardousMaterials="$certifyHazardousMaterials"
                                :certifyInvoiceAccuracy="$certifyInvoiceAccuracy" :certificationsCompleted="$this->certificationsCompleted" :carrierPackaging="$carrierPackaging"
                                :selectedPackaging="$selectedPackaging"
                                :isInsuranceChecked="$isInsuranceChecked"
                                :endUserTotal="$end_user_total"
