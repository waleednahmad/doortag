                ...
                <section class="mb-[1.489em] bg-gray-50 dark:bg-gray-800 rounded-lg p-4 sm:p-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
                                ...
                                <div class="col-span-full md:col-span-1 ">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-3 sm:gap-4">
                                        {{-- City --}}
                                        <x-input label="City *" wire:model="receiver.city" class="" required />
                                        {{-- State --}}
                                        <x-input label="State *" wire:model="receiver.state" class="" required />
                                        {{-- Zipcode --}}
                                        <x-input label="Zipcode *" wire:model="receiver.zip" class="" required />
                                    </div>
                                </div>
                                {{-- Country --}}
                        ...
                        <div x-data="{ packagingOpen: false }" class="rounded-[5px] border-2 transition-colors duration-200"
                            ...
                            <div @click="packagingOpen = !packagingOpen"
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-[.9em]">
                                        <h1 class="text-[1em] font-[400] text-gray-900 dark:text-gray-100">Box or Rigid
                                            Packaging</h1>
                                ...
                                <i class="fa-solid fa-caret-down text-[1.3em] text-gray-900 dark:text-gray-100"
                                    :class="packagingOpen ? 'rotate-180' : ''" style="transition: transform 0.2s;"></i>
                            </div>
                                ...
                                <div {{-- class="flex flex-col space-y-2 sm:flex-row sm:justify-between sm:items-center sm:space-y-0 mb-4 sm:mb-6">
                                    ...
                                    <div class="mb-6 sm:mb-8">
                                        ...
                                        <div class="hidden lg:grid lg:grid-cols-5 gap-4 items-end">
                                            <div>
                                                <x-input type="number" wire:model="pieces.{{ $index }}.length"
                                                    label="Length" placeholder="5.1" step="0.01" required />
                                            </div>
                                            <div
                                            ...
                                            <div>
                                                ...
                                                <x-input type="number" wire:model="pieces.{{ $index }}.width"
                                            ...
                                            <div>
                                                <x-input type="number" wire:model="pieces.{{ $index }}.height"
                                                    label="Height" placeholder="2.5" step="0.01" required />
                                            </div>
                                        </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-12 gap-4">
                                    <div class="md:col-span-11">
                                        <div class="flex items-center justify-between mb-3">
                                            ...
                                            <x-button.circle icon="plus" size="xs" color="primary" outline
                                                title="Add Line Item" />
                                        </div>
                    ...
                    <div class="my-4">
                        ...
                        <div x-show="savePackageChecked" x-transition class="mt-3">
                            <x-input label="Enter a nickname for your Saved Package" placeholder="Package nickname" />
                        </div>
                    </div>
                </section>
